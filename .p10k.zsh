...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_FOREGROUND=179
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_FOREGROUND=124
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_FOREGROUND=179
  ...
  # User
  typeset -g POWERLEVEL9K_USER_FOREGROUND=179
  typeset -g POWERLEVEL9K_USER_ICON='⚙'
  typeset -g POWERLEVEL9K_USER_DEFAULT_FOREGROUND=179
  typeset -g POWERLEVEL9K_USER_ROOT_FOREGROUND=124
  typeset -g POWERLEVEL9K_USER_ROOT_ICON='☩'
  typeset -g POWERLEVEL9K_USER_TEMPLATE='%n'

  # Host
  typeset -g POWERLEVEL9K_HOST_FOREGROUND=136
  ...
  # Date & Time
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=136
  ...
  # Load
  typeset -g POWERLEVEL9K_LOAD_FOREGROUND=179
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=179
  ...
  # RAM
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=136
  typeset -g POWERLEVEL9K_RAM_ICON='🧠'

  # Disk
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_FOREGROUND=136
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=179
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=136
  ...
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_FOREGROUND=124
  ...
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND=179
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_FOREGROUND=179
  ...
  # Background jobs
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=136
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_ICON='⚙'

  # Tmux
  typeset -g POWERLEVEL9K_TMUX_FOREGROUND=179
